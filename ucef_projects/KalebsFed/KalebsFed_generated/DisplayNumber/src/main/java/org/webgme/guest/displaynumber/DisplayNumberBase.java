package org.webgme.guest.displaynumber;

import org.webgme.guest.displaynumber.rti.*;
...
public class DisplayNumberBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public DisplayNumberBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // interaction pubsub
        TwoNumbers.publish(getLRC());
        AdditionOfTwo.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           AdditionOfTwo.get_handle(),
    ...
    public TwoNumbers create_TwoNumbers() {
        TwoNumbers interaction = new TwoNumbers();
