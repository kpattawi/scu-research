...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/Socket-${timestamp}.log -T "Socket" -geometry 140x40+60+90 -e "mvn exec:java -P ExecJava,Socket" &
waitUntilJoined Socket 1
