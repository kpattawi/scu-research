...
public class Socket1 extends Socket1Base {
    ...
    private void execute() throws Exception {
        ...
        while (!exitCondition) {
            ...
            while(!(varname = buffDummy.readLine()).isEmpty()) {
              ...
              ReceiveEp sendSimulationID = create_ReceiveEP{};
              sendSimulationID.set_simulationid( simulationID );
              log.info('Simulation ID: {}',simulationID);
              sendSimulationID.sendInteraction(getLRC(), currentTime + getLookAhead());
    ...
    private void handleInteractionClass(SendEP interaction) {
        ...
        double value = 20;
    	empty = false;
        if(simulationID.equals(interaction.get_simulationID())){
