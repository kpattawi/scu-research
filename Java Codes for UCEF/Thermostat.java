...
//            }
           ...
           //0.5 degree fuzzy control 
            ...
            ////////////////////////////////////////////////////////////
                ...
                SendEP simulationID = create_SendEP();                
                simulationID.set_simulationID(simulationID);
                System.out.println("Simulation ID: " + simulationID);
                simulationID.sendInteraction(getLRC(), currentTime + getLookAhead());
    ...
    private void handleInteractionClass(ReceiveEP interaction) {
        ...
        ///////////////////////////////////////////////////////////////
    	simulationID = interaction.get_simulationID();
