...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/EPSocket-${timestamp}.log -T "EPSocket" -geometry 140x40+30+60 -e "mvn exec:java -P ExecJava,EPSocket" &
waitUntilJoined EPSocket 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/Thermostat-${timestamp}.log -T "Thermostat" -geometry 140x40+60+90 -e "mvn exec:java -P ExecJava,Thermostat" &
