package org.webgme.guest.thermostat.rti;
...
/**
* Implements InteractionRoot.C2WInteractionRoot.SendToEP
*/
public class SendToEP extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the SendToEP interaction class with default parameter values.
    */
    public SendToEP() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the SendToEP interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the SendToEP interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.SendToEP";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the SendToEP interaction class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.SendToEP");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.SendToEP", SendToEP.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.SendToEP", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.SendToEP", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.SendToEP");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendToEP", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.SendToEP");
        _classHandleSimpleNameMap.put(get_handle(), "SendToEP");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendToEP.Data", _Data_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendToEP.NumberOfVariable", _NumberOfVariable_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendToEP.SimID", _SimID_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendToEP.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendToEP.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendToEP.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendToEP.sourceFed", _sourceFed_handle);
    ...
    /**
    * Publishes the SendToEP interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the SendToEP interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the SendToEP interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the SendToEP interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the SendToEP interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the SendToEP interaction class).
    ...
    */
    ...
    protected SendToEP( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected SendToEP( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the SendToEP interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new SendToEP interaction class instance
    */
    public SendToEP( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #SendToEP( ReceivedInteraction datamemberMap )}, except this
    * new SendToEP interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new SendToEP interaction class instance
    * @param logicalTime timestamp for this new SendToEP interaction class
    * instance
    */
    public SendToEP( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new SendToEP interaction class instance that is a duplicate
    * of the instance referred to by SendToEP_var.
    *
    * @param SendToEP_var SendToEP interaction class instance of which
    * this newly created SendToEP interaction class instance will be a
    * duplicate
    */
    public SendToEP( SendToEP SendToEP_var ) {
        super( SendToEP_var );

        set_Data( SendToEP_var.get_Data() );
        set_NumberOfVariable( SendToEP_var.get_NumberOfVariable() );
        set_SimID( SendToEP_var.get_SimID() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof SendToEP ) {
            SendToEP data = (SendToEP)object;
            _Data = data._Data;
