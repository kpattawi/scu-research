...
public class ThermostatBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public ThermostatBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // interaction pubsub
        SendToEP.publish(getLRC());
        ReceiveFromEP.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           ReceiveFromEP.get_handle(),
    ...
    public SendToEP create_SendToEP() {
        SendToEP interaction = new SendToEP();
