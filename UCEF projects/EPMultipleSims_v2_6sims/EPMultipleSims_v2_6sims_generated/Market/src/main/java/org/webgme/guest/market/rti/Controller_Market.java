package org.webgme.guest.market.rti;
...
/**
* Implements InteractionRoot.C2WInteractionRoot.Controller_Market
*/
public class Controller_Market extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the Controller_Market interaction class with default parameter values.
    */
    public Controller_Market() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the Controller_Market interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the Controller_Market interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.Controller_Market";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the Controller_Market interaction class.
    *
    * @return the name of this interaction class
    */
    public static String get_simple_class_name() {
        return "Controller_Market";
    }
    ...
    * Controller_Market interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.Controller_Market");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market", Controller_Market.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.Controller_Market");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.Controller_Market");
        _classHandleSimpleNameMap.put(get_handle(), "Controller_Market");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market.dataString", _dataString_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market.simID", _simID_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market.size", _size_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Controller_Market.sourceFed", _sourceFed_handle);
    ...
    /**
    * Publishes the Controller_Market interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the Controller_Market interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the Controller_Market interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the Controller_Market interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the Controller_Market interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the Controller_Market interaction class).
    ...
    */
    ...
    protected Controller_Market( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected Controller_Market( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the Controller_Market interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Controller_Market interaction class instance
    */
    public Controller_Market( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #Controller_Market( ReceivedInteraction datamemberMap )}, except this
    * new Controller_Market interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Controller_Market interaction class instance
    * @param logicalTime timestamp for this new Controller_Market interaction class
    * instance
    */
    public Controller_Market( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new Controller_Market interaction class instance that is a duplicate
    * of the instance referred to by Controller_Market_var.
    *
    * @param Controller_Market_var Controller_Market interaction class instance of which
    * this newly created Controller_Market interaction class instance will be a
    * duplicate
    */
    public Controller_Market( Controller_Market Controller_Market_var ) {
        super( Controller_Market_var );

        set_dataString( Controller_Market_var.get_dataString() );
        set_simID( Controller_Market_var.get_simID() );
        set_size( Controller_Market_var.get_size() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof Controller_Market ) {
            Controller_Market data = (Controller_Market)object;
