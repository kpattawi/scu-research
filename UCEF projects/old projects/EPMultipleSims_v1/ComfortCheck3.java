package org.webgme.guest.comfortcheck3;

import org.webgme.guest.comfortcheck3.rti.*;
...
// Define the ComfortCheck3 type of federate for the federation.

public class ComfortCheck3 extends ComfortCheck3Base {
    private final static Logger log = LogManager.getLogger();

    private double currentTime = 0;
    
    public ComfortCheck3(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            ComfortCheck3 federate =
                new ComfortCheck3(federateConfig);
            federate.execute();
            log.info("Done.");
            System.exit(0);
        }
