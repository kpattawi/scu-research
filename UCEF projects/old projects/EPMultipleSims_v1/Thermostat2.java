package org.webgme.guest.thermostat2;

import org.webgme.guest.thermostat2.rti.*;
...
// Define the Thermostat2 type of federate for the federation.

public class Thermostat2 extends Thermostat2Base {
    private final static Logger log = LogManager.getLogger();

    private double currentTime = 0;

    public Thermostat2(FederateConfig params) throws Exception {
        super(params);
    }
...
//            }
    ...
    public static void main(String[] args) {
        try {
            ...
            Thermostat2 federate =
                new Thermostat2(federateConfig);
            federate.execute();
            log.info("Done.");
            System.exit(0);
        }
