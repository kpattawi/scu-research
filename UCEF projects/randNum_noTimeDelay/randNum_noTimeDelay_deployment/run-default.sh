...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/NumGen-${timestamp}.log -T "NumGen" -geometry 140x40+30+60 -e "mvn exec:java -P ExecJava,NumGen" &
waitUntilJoined NumGen 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/Receiver-${timestamp}.log -T "Receiver" -geometry 140x40+60+90 -e "mvn exec:java -P ExecJava,Receiver" &
waitUntilJoined Receiver 1
