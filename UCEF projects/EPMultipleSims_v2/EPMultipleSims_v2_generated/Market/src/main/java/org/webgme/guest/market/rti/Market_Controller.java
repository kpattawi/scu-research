...
/**
* Implements InteractionRoot.C2WInteractionRoot.Market_Controller
*/
public class Market_Controller extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the Market_Controller interaction class with default parameter values.
    */
    ...
    /**
    * Returns the handle (RTI assigned) of the Market_Controller interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the Market_Controller interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.Market_Controller";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the Market_Controller interaction class.
    *
    ...
    * Market_Controller interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.Market_Controller");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller", Market_Controller.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.Market_Controller");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.Market_Controller");
        _classHandleSimpleNameMap.put(get_handle(), "Market_Controller");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller.dataString", _dataString_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller.simID", _simID_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller.size", _size_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Market_Controller.sourceFed", _sourceFed_handle);
    ...
    /**
    * Publishes the Market_Controller interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the Market_Controller interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the Market_Controller interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the Market_Controller interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the Market_Controller interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the Market_Controller interaction class).
    ...
    */
    ...
    protected Market_Controller( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected Market_Controller( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the Market_Controller interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Market_Controller interaction class instance
    */
    public Market_Controller( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #Market_Controller( ReceivedInteraction datamemberMap )}, except this
    * new Market_Controller interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Market_Controller interaction class instance
    * @param logicalTime timestamp for this new Market_Controller interaction class
    * instance
    */
    public Market_Controller( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new Market_Controller interaction class instance that is a duplicate
    * of the instance referred to by Market_Controller_var.
    *
    * @param Market_Controller_var Market_Controller interaction class instance of which
    * this newly created Market_Controller interaction class instance will be a
    * duplicate
    */
    public Market_Controller( Market_Controller Market_Controller_var ) {
        super( Market_Controller_var );

        set_dataString( Market_Controller_var.get_dataString() );
        set_simID( Market_Controller_var.get_simID() );
        set_size( Market_Controller_var.get_size() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof Market_Controller ) {
            Market_Controller data = (Market_Controller)object;
