package org.webgme.guest.socket4;

import org.webgme.guest.socket4.rti.*;
...
// Define the Socket4 type of federate for the federation.

public class Socket4 extends Socket4Base {
    ...
    int simID = 4;   // Change simID based on socket4 number
    ...
    public Socket4(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    private void execute() throws Exception {
        ...
        ServerSocket welcomeSocket = new ServerSocket(6793, 50, addr);  // 6789 is port number. Can be changed
