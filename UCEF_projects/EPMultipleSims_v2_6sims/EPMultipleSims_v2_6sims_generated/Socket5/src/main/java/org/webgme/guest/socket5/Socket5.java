package org.webgme.guest.socket5;

import org.webgme.guest.socket5.rti.*;
...
// Define the Socket5 type of federate for the federation.

public class Socket5 extends Socket5Base {
    ...
    int simID = 5;   // Change simID based on socket5 number
    ...
    public Socket5(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    private void execute() throws Exception {
        ...
        ServerSocket welcomeSocket = new ServerSocket(6794, 50, addr);  // 6789 is port number. Can be changed
