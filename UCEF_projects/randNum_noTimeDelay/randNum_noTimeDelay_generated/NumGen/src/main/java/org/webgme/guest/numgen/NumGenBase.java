...
public class NumGenBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public NumGenBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        NumGen_Receiver.publish(getLRC());
        Receiver_NumGen.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           Receiver_NumGen.get_handle(),
    ...
    public NumGen_Receiver create_NumGen_Receiver() {
        NumGen_Receiver interaction = new NumGen_Receiver();
        interaction.set_sourceFed(getFederateId());
        interaction.set_originFed(getFederateId());
        return interaction;
    }
