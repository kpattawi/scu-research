...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/Adder-${timestamp}.log -T "Adder" -geometry 140x40+30+60 -e "mvn exec:java -P ExecJava,Adder" &
waitUntilJoined Adder 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/DisplayNumber-${timestamp}.log -T "DisplayNumber" -geometry 140x40+60+90 -e "mvn exec:java -P ExecJava,DisplayNumber" &
waitUntilJoined DisplayNumber 1
