package org.webgme.guest.socket3;

import org.webgme.guest.socket3.rti.*;
...
// Define the Socket3 type of federate for the federation.

public class Socket3 extends Socket3Base {
    ...
    public Socket3(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    private void checkReceivedSubscriptions() {
        ...
        while ((interaction = getNextInteractionNoWait()) != null) {
            if (interaction instanceof SendEP3) {
                handleInteractionClass((SendEP3) interaction);                
            }
            else {
    ...
    private void execute() throws Exception {
        ...
        ServerSocket welcomeSocket = new ServerSocket(6791, 50, addr);  // 6790 is port number. Can be changed
        ...
        while (!exitCondition) {
            ...
            while(!(varname = buffDummy.readLine()).isEmpty()) {
              ...
              if(varname.equals("epSendOutdoorAirTemp")){
            	  ReceiveEp3 sendOutTemp = create_ReceiveEp3();
              ...
              if(varname.equals("epSendZoneMeanAirTemp")){
            	  ReceiveEp3 sendZoneTemp = create_ReceiveEp3();
              ...
              if(varname.equals("epSendZoneHumidity")){
            	  ReceiveEp3 sendRH = create_ReceiveEp3();
    ...
    private void handleInteractionClass(SendEP3 interaction) {
        ///////////////////////////////////////////////////////////////
