package org.webgme.guest.comfortcheck1;

import org.webgme.guest.comfortcheck1.rti.*;
...
// Define the ComfortCheck1 type of federate for the federation.

public class ComfortCheck1 extends ComfortCheck1Base {
    private final static Logger log = LogManager.getLogger();

    private double currentTime = 0;
    
    public ComfortCheck1(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    private void execute() throws Exception {
        ...
        while (!exitCondition) {
            ...
            try{
                  ...
                  String path="/home/vagrant/Desktop/EnergyPlusData/Adaptive_Test_Comfort1.txt";
    ...
    public static void main(String[] args) {
        try {
            ...
            ComfortCheck1 federate =
                new ComfortCheck1(federateConfig);
            federate.execute();
            log.info("Done.");
            System.exit(0);
        }
