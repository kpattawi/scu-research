package org.webgme.guest.thermostat3;

import org.webgme.guest.thermostat3.rti.*;
...
// Define the Thermostat3 type of federate for the federation.

public class Thermostat3 extends Thermostat3Base {
    private final static Logger log = LogManager.getLogger();

    private double currentTime = 0;

    public Thermostat3(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    private void checkReceivedSubscriptions() {
        ...
        while ((interaction = getNextInteractionNoWait()) != null) {
            if (interaction instanceof ReceiveEp3) {
                handleInteractionClass((ReceiveEp3) interaction);
            }
            else {
...
//	    heatTemp =-60;
            ...
            if (zoneTemp>=coolTemp+0.5-offset){
             ...
             Fuzzycool = 1;
              ...
              try{
                    ...
                    String path="/home/vagrant/Desktop/EnergyPlusData/Adaptive_Test_Occupancy3.txt";
    ...
    private void handleInteractionClass(ReceiveEp3 interaction) {
        ///////////////////////////////////////////////////////////////
    ...
    public static void main(String[] args) {
        try {
            ...
            Thermostat3 federate =
                new Thermostat3(federateConfig);
            federate.execute();
            log.info("Done.");
            System.exit(0);
        }
