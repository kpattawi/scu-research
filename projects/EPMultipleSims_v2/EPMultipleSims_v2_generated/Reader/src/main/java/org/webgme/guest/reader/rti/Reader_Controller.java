package org.webgme.guest.reader.rti;
...
/**
* Implements InteractionRoot.C2WInteractionRoot.Reader_Controller
*/
public class Reader_Controller extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the Reader_Controller interaction class with default parameter values.
    */
    public Reader_Controller() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the Reader_Controller interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the Reader_Controller interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.Reader_Controller";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the Reader_Controller interaction class.
    *
    * @return the name of this interaction class
    */
    public static String get_simple_class_name() {
        return "Reader_Controller";
    }
    ...
    * Reader_Controller interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.Reader_Controller");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller", Reader_Controller.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.Reader_Controller");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.Reader_Controller");
        _classHandleSimpleNameMap.put(get_handle(), "Reader_Controller");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller.dataString", _dataString_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller.simID", _simID_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller.size", _size_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Reader_Controller.sourceFed", _sourceFed_handle);
    ...
    /**
    * Publishes the Reader_Controller interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the Reader_Controller interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the Reader_Controller interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the Reader_Controller interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the Reader_Controller interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the Reader_Controller interaction class).
    ...
    */
    ...
    protected Reader_Controller( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected Reader_Controller( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the Reader_Controller interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Reader_Controller interaction class instance
    */
    public Reader_Controller( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #Reader_Controller( ReceivedInteraction datamemberMap )}, except this
    * new Reader_Controller interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Reader_Controller interaction class instance
    * @param logicalTime timestamp for this new Reader_Controller interaction class
    * instance
    */
    public Reader_Controller( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new Reader_Controller interaction class instance that is a duplicate
    * of the instance referred to by Reader_Controller_var.
    *
    * @param Reader_Controller_var Reader_Controller interaction class instance of which
    * this newly created Reader_Controller interaction class instance will be a
    * duplicate
    */
    public Reader_Controller( Reader_Controller Reader_Controller_var ) {
        super( Reader_Controller_var );

        set_dataString( Reader_Controller_var.get_dataString() );
        set_simID( Reader_Controller_var.get_simID() );
        set_size( Reader_Controller_var.get_size() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof Reader_Controller ) {
            Reader_Controller data = (Reader_Controller)object;
